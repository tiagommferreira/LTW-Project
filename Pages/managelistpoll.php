	...
	<table id="manage_polls_list" class="table table-striped table-hover">
	    <thead>
	        <tr>
	            ...
	            <th><center>Number of Polls</center></th>
	    ...
	    <tbody>
			<?php
				...
				$user_list_polls = get_list_polls_by_userid($user->getID());
				chdir('../');	// change dir to last dir
				if($user_list_polls!=false){
					foreach($user_list_polls as $list_poll){

			?>

	       	<tr> 
	            <td><center><?php echo $list_poll->getName(); ?> </center></td>
	            <td><center><?php echo count($list_poll->getPolls()); ?> </center></td>
	            <td><center>
					<button id="<?php echo $list_poll->getID(); ?>" onclick="deleteList(this)" style="border: 0px; background-color: rgba(255,0,0,0.0);"><i class="fa fa-times fa-lg" style="color: red;"></i></button>		
	            </center></td>

	            <td><center><button id="<?php echo $list_poll->getID(); ?>" onclick="openShareListModal(this)" style="border: 0px; background-color: rgba(255,0,0,0.0);"><i class="fa fa-external-link fa-lg"></i></button></center></td>
